...
let info = [];
if (result >= 90) {
    info = ["excellent", "darkgreen", "WOW! That's exceptional! You got all of the questions right! You're on the right way to becoming a great scientist. Do not waste your abilities. Now, it's time to discover more in the world of science and help other people solve their problems. Good luck!"];
} else if (result >= 75) {
    info = ["very good", "green", "Well done! That was awesome! You got almost all of the questions right. You're on your way to becoming a science expert. All you need is more practice and solving quizes. Never give up!"];
} else if (result >= 65) {
    ...
    info = ["bad", "red", "You got most of the questions wrong. This means you didn't study hard. You should study with more focus and memorize the information well, then come here and measure your level again."];
} else {
