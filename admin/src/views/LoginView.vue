...
async function login() {
    let member = await fetch("http://localhost/test123/info/functions/login.php", {
        method: "POST",
        credentials: "include",
        headers: {
...
<template>
    <form method="post" @submit.prevent="login" action="http://localhost/test123/info/functions/login.php">
